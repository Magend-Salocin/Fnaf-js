// ROOMS_CONFIG.js
// Source unique de verite pour les salles/cameras/parasites.

const ROOM_IDS_ORDER = [
  'safe', '1a', '1b', '1c', '2a', '2b', '3', '4a', '4b', '5', '6', '7'
];
...
const ROOMS = {
  safe: {
    id: 0,
    roomName: 'The Office',
    cameraName: 'The Office',
    image: 'images/rooms/the_office/default.png',
    width: 1600,
    height: 720,
    cameraOffset: 0,
    maxCameraOffset: 0,
    ...
    video: {
      ...
      horizontalBands: { enabled: false },
      randomHorizontalLines: { enabled: false }
    }
  },
  ...
  '1a': {
    ...
    roomName: 'Show Stage',
    cameraName: 'Cam 1A',
    image: 'images/rooms/1a_show_stage/1a_b0_c0_f0.jpg',
    width: 1200,
    height: 720,
    cameraOffset: 0,
    maxCameraOffset: 800,
  ...
  '1b': {
    ...
    cameraName: 'Cam 1B',
    image: 'images/rooms/1b_dining_area/1b_b0_c0_f0.jpg',
    width: 1200,
    height: 720,
    cameraOffset: 0,
    maxCameraOffset: 800,
    connectedTo: [
      { roomId: 1, doorId: null },
      { roomId: 5, doorId: null },
      { roomId: 7, doorId: null }
    ],
    camera: {
      maxUsageTime: 15,
      available: true
  ...
  '1c': {
    id: 7,
    roomName: 'Pirate Cove',
    cameraName: 'Cam 1C',
    image: 'images/rooms/1c_pirate_cove/1c_b0_c0_f0_00.jpg',
    width: 1200,
    height: 720,
    cameraOffset: 0,
    maxCameraOffset: 800,
  ...
  '2a': {
    id: 2,
    roomName: 'West Hall A',
    cameraName: 'Cam 2A',
    image: 'images/rooms/2a_west_hall/2a_b0_c0_f0.jpg',
    width: 1200,
    height: 720,
    cameraOffset: 0,
    maxCameraOffset: 800,
  ...
  '2b': {
    id: 4,
    roomName: 'West Hall B',
    cameraName: 'Cam 2B',
    image: 'images/rooms/2b_west_hall_corner/2b_b0_c0_f0.jpg',
    width: 1200,
    height: 720,
    cameraOffset: 0,
    maxCameraOffset: 800,
  ...
  '3': {
    id: 6,
    roomName: 'Supply Closet',
    cameraName: 'Cam 3',
    image: 'images/rooms/3_supply_closet/3_b0_c0_f0.jpg',
    width: 1200,
    height: 720,
    cameraOffset: 0,
    maxCameraOffset: 800,
  ...
  '4a': {
    id: 9,
    roomName: 'East Hall A',
    cameraName: 'Cam 4A',
    image: 'images/rooms/4a_east_hall/4a_b0_c0_f0.jpg',
    width: 1200,
    height: 720,
    cameraOffset: 0,
    maxCameraOffset: 800,
  ...
  '4b': {
    id: 10,
    roomName: 'East Hall B',
    cameraName: 'Cam 4B',
    image: 'images/rooms/4b_east_hall_corner/4b_b0_c0_f0.jpg',
    width: 1200,
    height: 720,
    cameraOffset: 0,
    maxCameraOffset: 800,
    connectedTo: [
      { roomId: 9, doorId: null },
      { roomId: 0, doorId: null }
    ],
    camera: {
      maxUsageTime: 15,
      available: true
  ...
  '5': {
    ...
    roomName: 'Backstage',
    cameraName: 'Cam 5',
    image: 'images/rooms/5_backstage/5_b0_c0_f0.jpg',
    width: 1200,
    height: 720,
    cameraOffset: 0,
    maxCameraOffset: 800,
    connectedTo: [
      { roomId: 6, doorId: null },
      { roomId: 4, doorId: null }
    ],
    camera: {
      maxUsageTime: 15,
  ...
  '6': {
    ...
    roomName: 'Kitchen',
    cameraName: 'Cam 6',
    image: 'images/rooms/6_kitchen/6_b0_c0_f0.png',
    width: 1600,
    height: 720,
    cameraOffset: 0,
    maxCameraOffset: -1,
  ...
  '7': {
    ...
    roomName: 'Restroom',
    cameraName: 'Cam 7',
    image: 'images/rooms/7_restroom/7_b0_c0_f0.jpg',
    width: 1200,
    height: 720,
    cameraOffset: 0,
    maxCameraOffset: 800,
